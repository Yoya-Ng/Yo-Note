...
export default function TenThousandHoursCalculator() {
    ...
    const [activities, setActivities] = useState([
        ...
        { id: 3, name: "睡覺", category: "日常生活", hoursPerSession: 8, daysPerWeek: 7, startAge: 6, endAge: 65, showInReport: false, color: "bg-yellow-200" },
        { id: 4, name: "吃飯", category: "日常生活", hoursPerSession: 3, daysPerWeek: 7, startAge: 6, endAge: 65, showInReport: false, color: "bg-yellow-200" },
